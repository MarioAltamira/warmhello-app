    ...
    <main className="shell">
      <section className="hero hero-grid">
        ...
        <div className="hero-visual card">
          ...
          <div className="hero-quote">
            ...
            <p>
              A gentle text arrives, tap confirms everything is okay, and the day begins without
              stress for anyone.
            </p>
          </div>
        </div>
      ...
      <section className="section story-section">
        ...
        <div className="card story-card">
          <p>
            You love your parents, but you also want to respect their space. You don&apos;t want to be
            overbearing calling every single morning at 8:00 AM just to make sure they&apos;re awake.
          </p>
          ...
          <p>You shouldn&apos;t have to trade their dignity for your peace of mind. Now, you don&apos;t have to.</p>
        </div>
      </section>
      ...
      <section className="section">
        ...
        <div className="grid three-up">
          ...
          <article className="card step-card">
            ...
            <p>
              They tap the secure link in the text and press one giant, high-contrast button that
              says &quot;I&apos;m OK.&quot; No typing required. It takes exactly two seconds.
            </p>
          </article>
          <article className="card step-card">
      ...
      <section className="section">
        ...
        <div className="grid three-up">
          ...
          <article className="card">
            ...
            <p>
              It doesn&apos;t feel like a medical alert or a tracking device. It feels like a quick
              morning wave across the fence.
            </p>
          </article>
          <article className="card">
            <h3>Reliable Infrastructure</h3>
            <p>
              Built on the same secure technology trusted by major banks and healthcare systems, so
              the automated clock never misses a beat.
            </p>
      ...
      <section className="section">
        ...
        <div className="faq-grid">
          <article className="card">
            ...
            <p>
              Absolutely. She never has to log in, type a password, or text back. She simply taps a
              single link and presses a large button on her screen.
            </p>
          </article>
          <article className="card">
            <h3>What if you need to pause for a special occasion?</h3>
            <p>
              You or your loved one can pause daily check-ins for specific dates from the dashboard
              so no false alarms are triggered.
            </p>
          </article>
          <article className="card">
            <h3>Can I add more than one emergency contact?</h3>
            <p>
              Yes. You can assign multiple people to receive the escalation alert if the morning
              check-in is missed.
            </p>
          </article>
        </div>
