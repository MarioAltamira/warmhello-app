...
const DEFAULT_CRON = "CRON_TZ=America/Toronto 0 23 * * *";
const DEFAULT_RETRIES = 0;
const JOB_PATH = "/api/jobs/reports/daily";
...
export async function POST(request: Request) {
  ...
  return NextResponse.json({
    ...
    dedupeBeforeCreate: dedupe,
    note: "Daily sales recap email fires at 23:00 (11:00 PM) America/Toronto covering the previous full midnight→midnight Eastern day.",
  });
}
